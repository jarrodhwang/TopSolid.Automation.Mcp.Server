...
internal static class Program
{
    private static async Task<int> Main(string[] args)
    {
        ...
        if (uiSmoke || uiBehavior)
            cases.Add((uiSmoke ? "WPF window initialization, MCP buttons, rendered layout, settings unchanged" : "WPF chat behavior, blue replies, elapsed time and unchanged settings (no raster validation)",
