...
namespace TopSolid.Automation.Mcp.Server.AddIn.Tools
{
    internal static class ToolingReadTools
    {
        public static void Register(AutomationGateway a, Action<ToolDefinition> register)
        {
            ...
            register(new ToolDefinition("topsolid_list_cam_tools", "List cam tools.", Schema.Page(new JObject { ["documentId"] = Schema.Text("Document revision ID; omit to use the active document.") }),
                p => a.Read("cam", () => AutomationValues.Page(TopSolidCamHost.Documents.GetTools(a.Document(p), false), p)), "Tooling", new string[0], true, new[] { "https://help.topsolid.com/7.20/en/TopSolid'Automation/api/cam/TopSolid.Cam.NC.Kernel.Automating.IDocuments.GetTools.html" }));
        }
    }
}
