...
namespace TopSolid.Automation.Mcp.Server.AddIn.Tools
{
    internal static class EntitiesReadTools
    {
        public static void Register(AutomationGateway a, Action<ToolDefinition> register)
        {
            ...
            register(new ToolDefinition("topsolid_list_parameters", "List parameter entity IDs from the native parameters folder only. Prefer list_parameter_values for names and typed values in one call.", Schema.Page(new JObject { ["documentId"] = Schema.Text("Document revision ID; omit to use the active document.") }),
